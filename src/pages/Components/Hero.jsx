...
export const Hero = () => {
  return (
    <section className="relative flex flex-col lg:flex-row items-center lg:min-h-[calc(100vh-64px)]">
      {/* Background Image */}
      ...
      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 z-20 md:left-0 md:top-0 md:translate-x-0">
        <img
          className="w-24 h-24 mx-5 my-10 bg-black"
          src={LogoOverlay}
          alt="Logo"
        />
      </div>
      ...
      {/* Content */}
      <div className="relative z-10 my-5 mx-5 sm:mx-10 lg:px-10 max-w-xl lg:max-w-2xl text-center lg:text-left mt-36 md:mt-40">
        ...
        <p className="text-xl text-black dark:text-white mb-6 lg:text-white leading-relaxed lg:max-w-lg mx-auto lg:mx-0">
